...
-- Purpose: initialize a blank database with platform-required assets plus test scene, fee, variable, formula and rule configuration for demonstrations.
-- Notes:
...
-- >>> BEGIN V20260410_029__thread10_remote_variable_http_layers.sql
set @current_schema = database();
...
execute stmt;
deallocate prepare stmt;
-- <<< END V20260410_029__thread10_remote_variable_http_layers.sql
