-- 首钢矿石人力与设备核算配置
-- 在平台基础初始化完成后导入，维护首钢矿石人力薪资与设备零工作业费用配置。
-- 范围：人力费用场景 SHOUGANG-ORE-HR-001；设备费用场景 SHOUGANG-ORE-DEVICE-001。
set names utf8mb4;
set foreign_key_checks = 0;

-- 一、首钢矿石人力薪资配置
insert into sys_dict_type (dict_id, dict_name, dict_type, status, create_by, create_time, remark)
select (select coalesce(max(dict_id), 0) + 1 from sys_dict_type), '核算-首钢苫盖动作', 'cost_sg_cover_action', '0', 'admin', sysdate(), '首钢矿石人力费用苫盖动作字典'
from dual
where not exists (select 1 from sys_dict_type where dict_type = 'cost_sg_cover_action');

insert into sys_dict_type (dict_id, dict_name, dict_type, status, create_by, create_time, remark)
select (select coalesce(max(dict_id), 0) + 1 from sys_dict_type), '核算-首钢苫盖货种', 'cost_sg_cover_cargo_type', '0', 'admin', sysdate(), '首钢矿石人力费用苫盖货种字典'
from dual
where not exists (select 1 from sys_dict_type where dict_type = 'cost_sg_cover_cargo_type');

insert into sys_dict_type (dict_id, dict_name, dict_type, status, create_by, create_time, remark)
select (select coalesce(max(dict_id), 0) + 1 from sys_dict_type), '核算-首钢带缆动作', 'cost_sg_mooring_action', '0', 'admin', sysdate(), '首钢矿石人力费用带缆动作字典'
from dual
where not exists (select 1 from sys_dict_type where dict_type = 'cost_sg_mooring_action');

insert into sys_dict_data (dict_code, dict_sort, dict_label, dict_value, dict_type, css_class, list_class, is_default, status, create_by, create_time, remark)
select (select coalesce(max(dict_code), 0) + 1 from sys_dict_data), 1, '苫盖', 'COVER', 'cost_sg_cover_action', '', 'primary', 'Y', '0', 'admin', sysdate(), '首钢苫盖作业'
from dual
where not exists (select 1 from sys_dict_data where dict_type = 'cost_sg_cover_action' and dict_value = 'COVER');

insert into sys_dict_data (dict_code, dict_sort, dict_label, dict_value, dict_type, css_class, list_class, is_default, status, create_by, create_time, remark)
select (select coalesce(max(dict_code), 0) + 1 from sys_dict_data), 2, '揭盖', 'UNCOVER', 'cost_sg_cover_action', '', 'warning', 'N', '0', 'admin', sysdate(), '首钢揭盖作业'
from dual
where not exists (select 1 from sys_dict_data where dict_type = 'cost_sg_cover_action' and dict_value = 'UNCOVER');

insert into sys_dict_data (dict_code, dict_sort, dict_label, dict_value, dict_type, css_class, list_class, is_default, status, create_by, create_time, remark)
select (select coalesce(max(dict_code), 0) + 1 from sys_dict_data), 1, '焦煤', 'COAL', 'cost_sg_cover_cargo_type', '', 'warning', 'Y', '0', 'admin', sysdate(), '首钢苫盖焦煤货种'
from dual
where not exists (select 1 from sys_dict_data where dict_type = 'cost_sg_cover_cargo_type' and dict_value = 'COAL');

insert into sys_dict_data (dict_code, dict_sort, dict_label, dict_value, dict_type, css_class, list_class, is_default, status, create_by, create_time, remark)
select (select coalesce(max(dict_code), 0) + 1 from sys_dict_data), 2, '矿石', 'ORE', 'cost_sg_cover_cargo_type', '', 'success', 'N', '0', 'admin', sysdate(), '首钢苫盖矿石货种'
from dual
where not exists (select 1 from sys_dict_data where dict_type = 'cost_sg_cover_cargo_type' and dict_value = 'ORE');

insert into sys_dict_data (dict_code, dict_sort, dict_label, dict_value, dict_type, css_class, list_class, is_default, status, create_by, create_time, remark)
select (select coalesce(max(dict_code), 0) + 1 from sys_dict_data), 1, '带缆', 'MOOR', 'cost_sg_mooring_action', '', 'primary', 'Y', '0', 'admin', sysdate(), '首钢带缆作业'
from dual
where not exists (select 1 from sys_dict_data where dict_type = 'cost_sg_mooring_action' and dict_value = 'MOOR');

insert into sys_dict_data (dict_code, dict_sort, dict_label, dict_value, dict_type, css_class, list_class, is_default, status, create_by, create_time, remark)
select (select coalesce(max(dict_code), 0) + 1 from sys_dict_data), 2, '解缆', 'UNMOOR', 'cost_sg_mooring_action', '', 'info', 'N', '0', 'admin', sysdate(), '首钢解缆作业'
from dual
...
select 'SHOUGANG-ORE-HR-001',
       ...
       '协力单位',
       '0',
       '根据首钢公司人力薪资思维导图整理的矿石场景费用配置；按第三方系统组织输入字段接入。',
       'admin',
       sysdate(),
       'admin',
       sysdate()
...
select s.scene_id, 'SG_BASE', '基础作业量', 10, '0', '吞吐量、清舱、零工与加班基础计量', 'admin', sysdate(), 'admin', sysdate()
from cost_scene s
...
insert into cost_variable_group (scene_id, group_code, group_name, sort_no, status, remark, create_by, create_time, update_by, update_time)
select s.scene_id, 'SG_ATTEND', '出勤与班组', 20, '0', '固定类劳务费和值守专班出勤维度', 'admin', sysdate(), 'admin', sysdate()
from cost_scene s
where s.scene_code = 'SHOUGANG-ORE-HR-001'
  and not exists (select 1 from cost_variable_group where scene_id = s.scene_id and group_code = 'SG_ATTEND');

insert into cost_variable_group (scene_id, group_code, group_name, sort_no, status, remark, create_by, create_time, update_by, update_time)
select s.scene_id, 'SG_SPECIAL', '专项作业', 30, '0', '苫盖、带缆等专项作业条件与数量', 'admin', sysdate(), 'admin', sysdate()
from cost_scene s
where s.scene_code = 'SHOUGANG-ORE-HR-001'
  and not exists (select 1 from cost_variable_group where scene_id = s.scene_id and group_code = 'SG_SPECIAL');

insert into cost_variable_group (scene_id, group_code, group_name, sort_no, status, remark, create_by, create_time, update_by, update_time)
select s.scene_id, 'SG_ALLOWANCE', '补贴与保险', 40, '0', '补贴、单位承担费用与保险类输入', 'admin', sysdate(), 'admin', sysdate()
from cost_scene s
where s.scene_code = 'SHOUGANG-ORE-HR-001'
  and not exists (select 1 from cost_variable_group where scene_id = s.scene_id and group_code = 'SG_ALLOWANCE');

insert into cost_variable_group (scene_id, group_code, group_name, sort_no, status, remark, create_by, create_time, update_by, update_time)
select s.scene_id, 'SG_FORMULA', '派生指标', 50, '0', '通过公式编码治理的派生指标', 'admin', sysdate(), 'admin', sysdate()
from cost_scene s
where s.scene_code = 'SHOUGANG-ORE-HR-001'
...
select s.scene_id,
       ...
       '0',
       50,
       '首钢费用：季节性补贴；请假扣减口径由第三方预先整理为计发份额',
       'admin',
       sysdate(),
       'admin',
       sysdate()
...
select s.scene_id, g.group_id, 'ALLOCATED_THROUGHPUT_TON', '吞吐量二次分配量', 'NUMBER', 'INPUT', '', 'ALLOCATED_THROUGHPUT_TON', null, '', 'NUMBER', '0', 4, '0', 10, '第三方整理后的吞吐量二次分配结果，按吨传入', 'admin', sysdate(), 'admin', sysdate()
from cost_scene s
...
insert into cost_variable (scene_id, group_id, variable_code, variable_name, variable_type, source_type, dict_type, data_path, formula_expr, formula_code, data_type, default_value, precision_scale, status, sort_no, remark, create_by, create_time, update_by, update_time)
select s.scene_id, g.group_id, 'HOLD_COUNT', '清舱舱数', 'NUMBER', 'INPUT', '', 'HOLD_COUNT', null, '', 'NUMBER', '0', 2, '0', 20, '清舱劳务费按舱数计价', 'admin', sysdate(), 'admin', sysdate()
from cost_scene s
join cost_variable_group g on g.scene_id = s.scene_id and g.group_code = 'SG_BASE'
where s.scene_code = 'SHOUGANG-ORE-HR-001'
...
insert into cost_variable (scene_id, group_id, variable_code, variable_name, variable_type, source_type, dict_type, data_path, formula_expr, formula_code, data_type, default_value, precision_scale, status, sort_no, remark, create_by, create_time, update_by, update_time)
select s.scene_id, g.group_id, 'ODD_JOB_HOURS', '零工作业时长', 'NUMBER', 'INPUT', '', 'ODD_JOB_HOURS', null, '', 'NUMBER', '0', 2, '0', 30, '零工费按小时计价', 'admin', sysdate(), 'admin', sysdate()
from cost_scene s
join cost_variable_group g on g.scene_id = s.scene_id and g.group_code = 'SG_BASE'
where s.scene_code = 'SHOUGANG-ORE-HR-001'
...
insert into cost_variable (scene_id, group_id, variable_code, variable_name, variable_type, source_type, dict_type, data_path, formula_expr, formula_code, data_type, default_value, precision_scale, status, sort_no, remark, create_by, create_time, update_by, update_time)
select s.scene_id, g.group_id, 'OVERTIME_DAYS', '加班天数', 'NUMBER', 'INPUT', '', 'OVERTIME_DAYS', null, '', 'NUMBER', '0', 2, '0', 40, '加班费用按天数计价', 'admin', sysdate(), 'admin', sysdate()
from cost_scene s
join cost_variable_group g on g.scene_id = s.scene_id and g.group_code = 'SG_BASE'
where s.scene_code = 'SHOUGANG-ORE-HR-001'
...
insert into cost_variable (scene_id, group_id, variable_code, variable_name, variable_type, source_type, dict_type, data_path, formula_expr, formula_code, data_type, default_value, precision_scale, status, sort_no, remark, create_by, create_time, update_by, update_time)
select s.scene_id, g.group_id, 'FEMALE_TEAM_HEADCOUNT', '队女工人数', 'NUMBER', 'INPUT', '', 'FEMALE_TEAM_HEADCOUNT', null, '', 'NUMBER', '0', 2, '0', 10, '女工固定类劳务费基础人数', 'admin', sysdate(), 'admin', sysdate()
from cost_scene s
...
insert into cost_variable (scene_id, group_id, variable_code, variable_name, variable_type, source_type, dict_type, data_path, formula_expr, formula_code, data_type, default_value, precision_scale, status, sort_no, remark, create_by, create_time, update_by, update_time)
select s.scene_id, g.group_id, 'FEMALE_ACTUAL_ATTENDANCE', '女工实际出勤', 'NUMBER', 'INPUT', '', 'FEMALE_ACTUAL_ATTENDANCE', null, '', 'NUMBER', '0', 2, '0', 20, '女工实际出勤量', 'admin', sysdate(), 'admin', sysdate()
from cost_scene s
join cost_variable_group g on g.scene_id = s.scene_id and g.group_code = 'SG_ATTEND'
where s.scene_code = 'SHOUGANG-ORE-HR-001'
...
insert into cost_variable (scene_id, group_id, variable_code, variable_name, variable_type, source_type, dict_type, data_path, formula_expr, formula_code, data_type, default_value, precision_scale, status, sort_no, remark, create_by, create_time, update_by, update_time)
select s.scene_id, g.group_id, 'FEMALE_REQUIRED_ATTENDANCE', '女工应出勤', 'NUMBER', 'INPUT', '', 'FEMALE_REQUIRED_ATTENDANCE', null, '', 'NUMBER', '1', 2, '0', 30, '女工应出勤量', 'admin', sysdate(), 'admin', sysdate()
from cost_scene s
join cost_variable_group g on g.scene_id = s.scene_id and g.group_code = 'SG_ATTEND'
where s.scene_code = 'SHOUGANG-ORE-HR-001'
...
insert into cost_variable (scene_id, group_id, variable_code, variable_name, variable_type, source_type, dict_type, data_path, formula_expr, formula_code, data_type, default_value, precision_scale, status, sort_no, remark, create_by, create_time, update_by, update_time)
select s.scene_id, g.group_id, 'SPECIAL_TEAM_HEADCOUNT', '专班人数', 'NUMBER', 'INPUT', '', 'SPECIAL_TEAM_HEADCOUNT', null, '', 'NUMBER', '0', 2, '0', 40, '清料专班、库场专班人数', 'admin', sysdate(), 'admin', sysdate()
from cost_scene s
join cost_variable_group g on g.scene_id = s.scene_id and g.group_code = 'SG_ATTEND'
where s.scene_code = 'SHOUGANG-ORE-HR-001'
...
insert into cost_variable (scene_id, group_id, variable_code, variable_name, variable_type, source_type, dict_type, data_path, formula_expr, formula_code, data_type, default_value, precision_scale, status, sort_no, remark, create_by, create_time, update_by, update_time)
select s.scene_id, g.group_id, 'SPECIAL_ACTUAL_ATTENDANCE', '专班实际出勤', 'NUMBER', 'INPUT', '', 'SPECIAL_ACTUAL_ATTENDANCE', null, '', 'NUMBER', '0', 2, '0', 50, '清料专班、库场专班实际出勤量', 'admin', sysdate(), 'admin', sysdate()
from cost_scene s
join cost_variable_group g on g.scene_id = s.scene_id and g.group_code = 'SG_ATTEND'
where s.scene_code = 'SHOUGANG-ORE-HR-001'
...
insert into cost_variable (scene_id, group_id, variable_code, variable_name, variable_type, source_type, dict_type, data_path, formula_expr, formula_code, data_type, default_value, precision_scale, status, sort_no, remark, create_by, create_time, update_by, update_time)
select s.scene_id, g.group_id, 'SPECIAL_REQUIRED_ATTENDANCE', '专班应出勤', 'NUMBER', 'INPUT', '', 'SPECIAL_REQUIRED_ATTENDANCE', null, '', 'NUMBER', '1', 2, '0', 60, '清料专班、库场专班应出勤量', 'admin', sysdate(), 'admin', sysdate()
from cost_scene s
join cost_variable_group g on g.scene_id = s.scene_id and g.group_code = 'SG_ATTEND'
where s.scene_code = 'SHOUGANG-ORE-HR-001'
...
insert into cost_variable (scene_id, group_id, variable_code, variable_name, variable_type, source_type, dict_type, data_path, formula_expr, formula_code, data_type, default_value, precision_scale, status, sort_no, remark, create_by, create_time, update_by, update_time)
select s.scene_id, g.group_id, 'DUTY_TEAM_ACTUAL_ATTENDANCE', '值守队实际出勤', 'NUMBER', 'INPUT', '', 'DUTY_TEAM_ACTUAL_ATTENDANCE', null, '', 'NUMBER', '0', 2, '0', 70, '值守专班该队实际出勤量', 'admin', sysdate(), 'admin', sysdate()
from cost_scene s
join cost_variable_group g on g.scene_id = s.scene_id and g.group_code = 'SG_ATTEND'
where s.scene_code = 'SHOUGANG-ORE-HR-001'
...
insert into cost_variable (scene_id, group_id, variable_code, variable_name, variable_type, source_type, dict_type, data_path, formula_expr, formula_code, data_type, default_value, precision_scale, status, sort_no, remark, create_by, create_time, update_by, update_time)
select s.scene_id, g.group_id, 'DUTY_TEAM_REQUIRED_ATTENDANCE', '值守队应出勤', 'NUMBER', 'INPUT', '', 'DUTY_TEAM_REQUIRED_ATTENDANCE', null, '', 'NUMBER', '1', 2, '0', 80, '值守专班该队应出勤量', 'admin', sysdate(), 'admin', sysdate()
from cost_scene s
join cost_variable_group g on g.scene_id = s.scene_id and g.group_code = 'SG_ATTEND'
where s.scene_code = 'SHOUGANG-ORE-HR-001'
...
insert into cost_variable (scene_id, group_id, variable_code, variable_name, variable_type, source_type, dict_type, data_path, formula_expr, formula_code, data_type, default_value, precision_scale, status, sort_no, remark, create_by, create_time, update_by, update_time)
select s.scene_id, g.group_id, 'ALL_TEAMS_REQUIRED_ATTENDANCE', '所有队应出勤', 'NUMBER', 'INPUT', '', 'ALL_TEAMS_REQUIRED_ATTENDANCE', null, '', 'NUMBER', '1', 2, '0', 90, '值守专班所有队应出勤量', 'admin', sysdate(), 'admin', sysdate()
from cost_scene s
join cost_variable_group g on g.scene_id = s.scene_id and g.group_code = 'SG_ATTEND'
where s.scene_code = 'SHOUGANG-ORE-HR-001'
...
insert into cost_variable (scene_id, group_id, variable_code, variable_name, variable_type, source_type, dict_type, data_path, formula_expr, formula_code, data_type, default_value, precision_scale, status, sort_no, remark, create_by, create_time, update_by, update_time)
select s.scene_id, g.group_id, 'COVER_ACTION', '苫盖动作', 'DICT', 'DICT', 'cost_sg_cover_action', 'COVER_ACTION', null, '', 'STRING', '', 2, '0', 10, '苫盖零工劳务费动作条件', 'admin', sysdate(), 'admin', sysdate()
from cost_scene s
...
insert into cost_variable (scene_id, group_id, variable_code, variable_name, variable_type, source_type, dict_type, data_path, formula_expr, formula_code, data_type, default_value, precision_scale, status, sort_no, remark, create_by, create_time, update_by, update_time)
select s.scene_id, g.group_id, 'COVER_CARGO_TYPE', '苫盖货种', 'DICT', 'DICT', 'cost_sg_cover_cargo_type', 'COVER_CARGO_TYPE', null, '', 'STRING', '', 2, '0', 20, '苫盖零工劳务费货种条件', 'admin', sysdate(), 'admin', sysdate()
from cost_scene s
join cost_variable_group g on g.scene_id = s.scene_id and g.group_code = 'SG_SPECIAL'
where s.scene_code = 'SHOUGANG-ORE-HR-001'
...
insert into cost_variable (scene_id, group_id, variable_code, variable_name, variable_type, source_type, dict_type, data_path, formula_expr, formula_code, data_type, default_value, precision_scale, status, sort_no, remark, create_by, create_time, update_by, update_time)
select s.scene_id, g.group_id, 'COVER_WORKLOAD_TON', '苫盖作业量', 'NUMBER', 'INPUT', '', 'COVER_WORKLOAD_TON', null, '', 'NUMBER', '0', 4, '0', 30, '苫盖零工劳务费按作业量计价', 'admin', sysdate(), 'admin', sysdate()
from cost_scene s
join cost_variable_group g on g.scene_id = s.scene_id and g.group_code = 'SG_SPECIAL'
where s.scene_code = 'SHOUGANG-ORE-HR-001'
...
insert into cost_variable (scene_id, group_id, variable_code, variable_name, variable_type, source_type, dict_type, data_path, formula_expr, formula_code, data_type, default_value, precision_scale, status, sort_no, remark, create_by, create_time, update_by, update_time)
select s.scene_id, g.group_id, 'MOORING_ACTION', '带缆动作', 'DICT', 'DICT', 'cost_sg_mooring_action', 'MOORING_ACTION', null, '', 'STRING', '', 2, '0', 40, '带缆费动作条件', 'admin', sysdate(), 'admin', sysdate()
from cost_scene s
join cost_variable_group g on g.scene_id = s.scene_id and g.group_code = 'SG_SPECIAL'
where s.scene_code = 'SHOUGANG-ORE-HR-001'
...
insert into cost_variable (scene_id, group_id, variable_code, variable_name, variable_type, source_type, dict_type, data_path, formula_expr, formula_code, data_type, default_value, precision_scale, status, sort_no, remark, create_by, create_time, update_by, update_time)
select s.scene_id, g.group_id, 'MOORING_HEADCOUNT', '带缆作业人数', 'NUMBER', 'INPUT', '', 'MOORING_HEADCOUNT', null, '', 'NUMBER', '0', 2, '0', 50, '由第三方按船型和动作整理后传入作业人数', 'admin', sysdate(), 'admin', sysdate()
from cost_scene s
join cost_variable_group g on g.scene_id = s.scene_id and g.group_code = 'SG_SPECIAL'
where s.scene_code = 'SHOUGANG-ORE-HR-001'
...
insert into cost_variable (scene_id, group_id, variable_code, variable_name, variable_type, source_type, dict_type, data_path, formula_expr, formula_code, data_type, default_value, precision_scale, status, sort_no, remark, create_by, create_time, update_by, update_time)
select s.scene_id, g.group_id, 'SEASONAL_SUBSIDY_EQUIV', '季节性补贴计发份额', 'NUMBER', 'INPUT', '', 'SEASONAL_SUBSIDY_EQUIV', null, '', 'NUMBER', '0', 4, '0', 10, '第三方按请假扣减规则整理后的计发份额', 'admin', sysdate(), 'admin', sysdate()
from cost_scene s
...
insert into cost_variable (scene_id, group_id, variable_code, variable_name, variable_type, source_type, dict_type, data_path, formula_expr, formula_code, data_type, default_value, precision_scale, status, sort_no, remark, create_by, create_time, update_by, update_time)
select s.scene_id, g.group_id, 'UNIT_BEARING_AMOUNT', '单位承担费用', 'NUMBER', 'INPUT', '', 'UNIT_BEARING_AMOUNT', null, '', 'NUMBER', '0', 2, '0', 20, '单位承担部分的费用，支持手工录入或导入', 'admin', sysdate(), 'admin', sysdate()
from cost_scene s
join cost_variable_group g on g.scene_id = s.scene_id and g.group_code = 'SG_ALLOWANCE'
where s.scene_code = 'SHOUGANG-ORE-HR-001'
...
insert into cost_variable (scene_id, group_id, variable_code, variable_name, variable_type, source_type, dict_type, data_path, formula_expr, formula_code, data_type, default_value, precision_scale, status, sort_no, remark, create_by, create_time, update_by, update_time)
select s.scene_id, g.group_id, 'INSURANCE_TAXABLE_AMOUNT', '五险应税额', 'NUMBER', 'INPUT', '', 'INSURANCE_TAXABLE_AMOUNT', null, '', 'NUMBER', '0', 2, '0', 30, '五险应税额，支持手工录入', 'admin', sysdate(), 'admin', sysdate()
from cost_scene s
join cost_variable_group g on g.scene_id = s.scene_id and g.group_code = 'SG_ALLOWANCE'
where s.scene_code = 'SHOUGANG-ORE-HR-001'
...
insert into cost_variable (scene_id, group_id, variable_code, variable_name, variable_type, source_type, dict_type, data_path, formula_expr, formula_code, data_type, default_value, precision_scale, status, sort_no, remark, create_by, create_time, update_by, update_time)
select s.scene_id, g.group_id, 'EMPLOYER_LIABILITY_AMOUNT', '雇主责任险', 'NUMBER', 'INPUT', '', 'EMPLOYER_LIABILITY_AMOUNT', null, '', 'NUMBER', '0', 2, '0', 40, '雇主责任险，支持手工录入', 'admin', sysdate(), 'admin', sysdate()
from cost_scene s
join cost_variable_group g on g.scene_id = s.scene_id and g.group_code = 'SG_ALLOWANCE'
where s.scene_code = 'SHOUGANG-ORE-HR-001'
...
insert into cost_variable (scene_id, group_id, variable_code, variable_name, variable_type, source_type, dict_type, data_path, formula_expr, formula_code, data_type, default_value, precision_scale, status, sort_no, remark, create_by, create_time, update_by, update_time)
select s.scene_id, g.group_id, 'FEMALE_ATTENDANCE_EQUIV', '女工出勤折算量', 'FORMULA', 'FORMULA', '', 'FEMALE_ATTENDANCE_EQUIV', 'V.FEMALE_TEAM_HEADCOUNT * (V.FEMALE_ACTUAL_ATTENDANCE / max(V.FEMALE_REQUIRED_ATTENDANCE, 1))', 'SG_FORMULA_FEMALE_ATTEND_EQUIV', 'NUMBER', '0', 4, '0', 10, '公式派生：女工出勤折算量', 'admin', sysdate(), 'admin', sysdate()
from cost_scene s
...
insert into cost_variable (scene_id, group_id, variable_code, variable_name, variable_type, source_type, dict_type, data_path, formula_expr, formula_code, data_type, default_value, precision_scale, status, sort_no, remark, create_by, create_time, update_by, update_time)
select s.scene_id, g.group_id, 'SPECIAL_ATTENDANCE_EQUIV', '专班出勤折算量', 'FORMULA', 'FORMULA', '', 'SPECIAL_ATTENDANCE_EQUIV', 'V.SPECIAL_TEAM_HEADCOUNT * (V.SPECIAL_ACTUAL_ATTENDANCE / max(V.SPECIAL_REQUIRED_ATTENDANCE, 1))', 'SG_FORMULA_SPECIAL_ATTEND_EQUIV', 'NUMBER', '0', 4, '0', 20, '公式派生：清料专班、库场专班出勤折算量', 'admin', sysdate(), 'admin', sysdate()
from cost_scene s
join cost_variable_group g on g.scene_id = s.scene_id and g.group_code = 'SG_FORMULA'
where s.scene_code = 'SHOUGANG-ORE-HR-001'
...
select s.scene_id, 'SG_THRPT_PIECE_FEE', '吞吐量计件类费用', '劳务费', '吨', '吞吐量二次分配量 * 0.261 元/吨', '适用于矿石场景吞吐量计件费用', '协力单位', 10, '0', '首钢费用：吞吐量计件类费用', 'admin', sysdate(), 'admin', sysdate()
from cost_scene s
where s.scene_code = 'SHOUGANG-ORE-HR-001'
  and not exists (select 1 from cost_fee_item where scene_id = s.scene_id and fee_code = 'SG_THRPT_PIECE_FEE');

insert into cost_fee_item (scene_id, fee_code, fee_name, fee_category, unit_code, factor_summary, scope_description, object_dimension, sort_no, status, remark, create_by, create_time, update_by, update_time)
select s.scene_id, 'SG_FEMALE_SHIFT_LABOR', '女工固定类劳务费', '固定劳务费', '折算量', '21700/6 * 女工出勤折算量', '适用于倒班女工固定类劳务费', '协力单位', 20, '0', '首钢费用：女工（倒班，编制 6 人）', 'admin', sysdate(), 'admin', sysdate()
from cost_scene s
where s.scene_code = 'SHOUGANG-ORE-HR-001'
  and not exists (select 1 from cost_fee_item where scene_id = s.scene_id and fee_code = 'SG_FEMALE_SHIFT_LABOR');

insert into cost_fee_item (scene_id, fee_code, fee_name, fee_category, unit_code, factor_summary, scope_description, object_dimension, sort_no, status, remark, create_by, create_time, update_by, update_time)
select s.scene_id, 'SG_SPECIAL_SHIFT_LABOR', '清料专班库场专班固定类劳务费', '固定劳务费', '折算量', '253000/30 * 专班出勤折算量', '适用于清料专班、库场专班固定类劳务费', '协力单位', 30, '0', '首钢费用：清料专班、库场专班（白班，编制 30 人）', 'admin', sysdate(), 'admin', sysdate()
from cost_scene s
where s.scene_code = 'SHOUGANG-ORE-HR-001'
  and not exists (select 1 from cost_fee_item where scene_id = s.scene_id and fee_code = 'SG_SPECIAL_SHIFT_LABOR');

insert into cost_fee_item (scene_id, fee_code, fee_name, fee_category, unit_code, factor_summary, scope_description, object_dimension, sort_no, status, remark, create_by, create_time, update_by, update_time)
select s.scene_id, 'SG_HOLD_CLEANING_LABOR', '清舱劳务费', '劳务费', '舱', '清舱舱数 * 250 元/舱', '适用于值守专班清舱作业', '协力单位', 40, '0', '首钢费用：清舱劳务费', 'admin', sysdate(), 'admin', sysdate()
from cost_scene s
where s.scene_code = 'SHOUGANG-ORE-HR-001'
  and not exists (select 1 from cost_fee_item where scene_id = s.scene_id and fee_code = 'SG_HOLD_CLEANING_LABOR');

insert into cost_fee_item (scene_id, fee_code, fee_name, fee_category, unit_code, factor_summary, scope_description, object_dimension, sort_no, status, remark, create_by, create_time, update_by, update_time)
select s.scene_id, 'SG_COVER_ODD_JOB_LABOR', '苫盖零工劳务费', '劳务费', '吨', '按苫盖动作 + 货种组合命中费率，再乘作业量', '适用于苫盖/揭盖焦煤、矿石场景', '协力单位', 50, '0', '首钢费用：苫盖零工劳务费（很少发生）', 'admin', sysdate(), 'admin', sysdate()
from cost_scene s
where s.scene_code = 'SHOUGANG-ORE-HR-001'
  and not exists (select 1 from cost_fee_item where scene_id = s.scene_id and fee_code = 'SG_COVER_ODD_JOB_LABOR');

insert into cost_fee_item (scene_id, fee_code, fee_name, fee_category, unit_code, factor_summary, scope_description, object_dimension, sort_no, status, remark, create_by, create_time, update_by, update_time)
select s.scene_id, 'SG_MOORING_FEE', '带缆费', '劳务费', '人次', '按带缆动作命中单价，再乘整理后的作业人数', '适用于带缆/解缆场景；人数由第三方按船型标准整理', '协力单位', 60, '0', '首钢费用：带缆费', 'admin', sysdate(), 'admin', sysdate()
from cost_scene s
where s.scene_code = 'SHOUGANG-ORE-HR-001'
  and not exists (select 1 from cost_fee_item where scene_id = s.scene_id and fee_code = 'SG_MOORING_FEE');

insert into cost_fee_item (scene_id, fee_code, fee_name, fee_category, unit_code, factor_summary, scope_description, object_dimension, sort_no, status, remark, create_by, create_time, update_by, update_time)
select s.scene_id, 'SG_ODD_JOB_FEE', '零工费', '劳务费', '小时', '零工作业时长 * 5 元/小时', '适用于零工作业场景', '协力单位', 70, '0', '首钢费用：零工费', 'admin', sysdate(), 'admin', sysdate()
from cost_scene s
where s.scene_code = 'SHOUGANG-ORE-HR-001'
  and not exists (select 1 from cost_fee_item where scene_id = s.scene_id and fee_code = 'SG_ODD_JOB_FEE');

insert into cost_fee_item (scene_id, fee_code, fee_name, fee_category, unit_code, factor_summary, scope_description, object_dimension, sort_no, status, remark, create_by, create_time, update_by, update_time)
select s.scene_id, 'SG_DUTY_SHIFT_LABOR', '值守专班劳务费', '劳务费', '元', '按前置费用差额 * 值守专班分摊系数计算', '适用于值守专班倒班场景', '协力单位', 80, '0', '首钢费用：值守专班劳务费', 'admin', sysdate(), 'admin', sysdate()
from cost_scene s
where s.scene_code = 'SHOUGANG-ORE-HR-001'
  and not exists (select 1 from cost_fee_item where scene_id = s.scene_id and fee_code = 'SG_DUTY_SHIFT_LABOR');

insert into cost_fee_item (scene_id, fee_code, fee_name, fee_category, unit_code, factor_summary, scope_description, object_dimension, sort_no, status, remark, create_by, create_time, update_by, update_time)
select s.scene_id, 'SG_SEASONAL_ALLOWANCE', '季节性补贴', '补贴', '元', '账期命中 12/01/02/03 后按 500 元 * 计发份额计算', '适用于资金池发放中的季节性补贴', '协力单位', 90, '0', '首钢费用：季节性补贴；春节补贴暂不纳入', 'admin', sysdate(), 'admin', sysdate()
from cost_scene s
where s.scene_code = 'SHOUGANG-ORE-HR-001'
  and not exists (select 1 from cost_fee_item where scene_id = s.scene_id and fee_code = 'SG_SEASONAL_ALLOWANCE');

insert into cost_fee_item (scene_id, fee_code, fee_name, fee_category, unit_code, factor_summary, scope_description, object_dimension, sort_no, status, remark, create_by, create_time, update_by, update_time)
select s.scene_id, 'SG_OVERTIME_FEE', '加班费用', '补贴', '天', '加班天数 * 240 元', '适用于所有人加班费用', '协力单位', 100, '0', '首钢费用：加班费用', 'admin', sysdate(), 'admin', sysdate()
from cost_scene s
where s.scene_code = 'SHOUGANG-ORE-HR-001'
  and not exists (select 1 from cost_fee_item where scene_id = s.scene_id and fee_code = 'SG_OVERTIME_FEE');

insert into cost_fee_item (scene_id, fee_code, fee_name, fee_category, unit_code, factor_summary, scope_description, object_dimension, sort_no, status, remark, create_by, create_time, update_by, update_time)
select s.scene_id, 'SG_UNIT_BEARING_FEE', '单位承担部分的费用', '保险类费用', '元', '第三方组织好的直接金额', '适用于单位承担部分费用，支持手工录入/导入', '协力单位', 110, '0', '首钢费用：单位承担部分的费用', 'admin', sysdate(), 'admin', sysdate()
from cost_scene s
where s.scene_code = 'SHOUGANG-ORE-HR-001'
  and not exists (select 1 from cost_fee_item where scene_id = s.scene_id and fee_code = 'SG_UNIT_BEARING_FEE');

insert into cost_fee_item (scene_id, fee_code, fee_name, fee_category, unit_code, factor_summary, scope_description, object_dimension, sort_no, status, remark, create_by, create_time, update_by, update_time)
select s.scene_id, 'SG_INSURANCE_TAXABLE_FEE', '五险应税额', '保险类费用', '元', '第三方组织好的直接金额', '适用于五险应税额录入', '协力单位', 120, '0', '首钢费用：五险应税额', 'admin', sysdate(), 'admin', sysdate()
from cost_scene s
where s.scene_code = 'SHOUGANG-ORE-HR-001'
  and not exists (select 1 from cost_fee_item where scene_id = s.scene_id and fee_code = 'SG_INSURANCE_TAXABLE_FEE');

insert into cost_fee_item (scene_id, fee_code, fee_name, fee_category, unit_code, factor_summary, scope_description, object_dimension, sort_no, status, remark, create_by, create_time, update_by, update_time)
select s.scene_id, 'SG_EMPLOYER_LIABILITY_FEE', '雇主责任险', '保险类费用', '元', '第三方组织好的直接金额', '适用于雇主责任险录入', '协力单位', 130, '0', '首钢费用：雇主责任险', 'admin', sysdate(), 'admin', sysdate()
from cost_scene s
where s.scene_code = 'SHOUGANG-ORE-HR-001'
  and not exists (select 1 from cost_fee_item where scene_id = s.scene_id and fee_code = 'SG_EMPLOYER_LIABILITY_FEE');

insert into cost_fee_item (scene_id, fee_code, fee_name, fee_category, unit_code, factor_summary, scope_description, object_dimension, sort_no, status, remark, create_by, create_time, update_by, update_time)
select s.scene_id, 'SG_MANAGEMENT_FEE', '协力单位管理费', '管理费', '元', '除保险费之外的上述所有费用总和 * 16.77%', '适用于协力单位管理费', '协力单位', 140, '0', '首钢费用：协力单位管理费', 'admin', sysdate(), 'admin', sysdate()
from cost_scene s
where s.scene_code = 'SHOUGANG-ORE-HR-001'
...
select s.scene_id, f.fee_id, v.variable_id, 'REQUIRED', 10, '吞吐量计件类费用依赖吞吐量二次分配量', 'admin', sysdate(), 'admin', sysdate()
from cost_scene s
...
insert into cost_fee_variable_rel (scene_id, fee_id, variable_id, relation_type, sort_no, remark, create_by, create_time, update_by, update_time)
select s.scene_id, f.fee_id, v.variable_id, 'FORMULA_INPUT', 10, '女工固定类劳务费按女工出勤折算量计价', 'admin', sysdate(), 'admin', sysdate()
from cost_scene s
...
insert into cost_fee_variable_rel (scene_id, fee_id, variable_id, relation_type, sort_no, remark, create_by, create_time, update_by, update_time)
select s.scene_id, f.fee_id, v.variable_id, 'FORMULA_INPUT', 10, '清料专班库场专班固定类劳务费按专班出勤折算量计价', 'admin', sysdate(), 'admin', sysdate()
from cost_scene s
...
insert into cost_fee_variable_rel (scene_id, fee_id, variable_id, relation_type, sort_no, remark, create_by, create_time, update_by, update_time)
select s.scene_id, f.fee_id, v.variable_id, 'REQUIRED', 10, '清舱劳务费依赖清舱数量', 'admin', sysdate(), 'admin', sysdate()
from cost_scene s
...
insert into cost_fee_variable_rel (scene_id, fee_id, variable_id, relation_type, sort_no, remark, create_by, create_time, update_by, update_time)
select s.scene_id, f.fee_id, v.variable_id, 'REQUIRED', 10, '苫盖零工劳务费依赖苫盖动作', 'admin', sysdate(), 'admin', sysdate()
from cost_scene s
...
insert into cost_fee_variable_rel (scene_id, fee_id, variable_id, relation_type, sort_no, remark, create_by, create_time, update_by, update_time)
select s.scene_id, f.fee_id, v.variable_id, 'REQUIRED', 20, '苫盖零工劳务费依赖货种', 'admin', sysdate(), 'admin', sysdate()
from cost_scene s
join cost_fee_item f on f.scene_id = s.scene_id and f.fee_code = 'SG_COVER_ODD_JOB_LABOR'
...
insert into cost_fee_variable_rel (scene_id, fee_id, variable_id, relation_type, sort_no, remark, create_by, create_time, update_by, update_time)
select s.scene_id, f.fee_id, v.variable_id, 'REQUIRED', 30, '苫盖零工劳务费按作业量计价', 'admin', sysdate(), 'admin', sysdate()
from cost_scene s
join cost_fee_item f on f.scene_id = s.scene_id and f.fee_code = 'SG_COVER_ODD_JOB_LABOR'
...
insert into cost_fee_variable_rel (scene_id, fee_id, variable_id, relation_type, sort_no, remark, create_by, create_time, update_by, update_time)
select s.scene_id, f.fee_id, v.variable_id, 'REQUIRED', 10, '带缆费依赖带缆动作', 'admin', sysdate(), 'admin', sysdate()
from cost_scene s
...
insert into cost_fee_variable_rel (scene_id, fee_id, variable_id, relation_type, sort_no, remark, create_by, create_time, update_by, update_time)
select s.scene_id, f.fee_id, v.variable_id, 'REQUIRED', 20, '带缆费依赖第三方整理后的作业人数', 'admin', sysdate(), 'admin', sysdate()
from cost_scene s
join cost_fee_item f on f.scene_id = s.scene_id and f.fee_code = 'SG_MOORING_FEE'
...
insert into cost_fee_variable_rel (scene_id, fee_id, variable_id, relation_type, sort_no, remark, create_by, create_time, update_by, update_time)
select s.scene_id, f.fee_id, v.variable_id, 'REQUIRED', 10, '零工费按零工工时计价', 'admin', sysdate(), 'admin', sysdate()
from cost_scene s
...
insert into cost_fee_variable_rel (scene_id, fee_id, variable_id, relation_type, sort_no, remark, create_by, create_time, update_by, update_time)
select s.scene_id, f.fee_id, v.variable_id, 'FORMULA_INPUT', 10, '值守专班劳务费按分摊系数承接公式计算', 'admin', sysdate(), 'admin', sysdate()
from cost_scene s
...
insert into cost_fee_variable_rel (scene_id, fee_id, variable_id, relation_type, sort_no, remark, create_by, create_time, update_by, update_time)
select s.scene_id, f.fee_id, v.variable_id, 'FORMULA_INPUT', 10, '季节性补贴依赖第三方整理后的计发份额', 'admin', sysdate(), 'admin', sysdate()
from cost_scene s
...
insert into cost_fee_variable_rel (scene_id, fee_id, variable_id, relation_type, sort_no, remark, create_by, create_time, update_by, update_time)
select s.scene_id, f.fee_id, v.variable_id, 'REQUIRED', 10, '加班费用按加班天数计价', 'admin', sysdate(), 'admin', sysdate()
from cost_scene s
...
insert into cost_fee_variable_rel (scene_id, fee_id, variable_id, relation_type, sort_no, remark, create_by, create_time, update_by, update_time)
select s.scene_id, f.fee_id, v.variable_id, 'REQUIRED', 10, '单位承担费用按输入金额直传', 'admin', sysdate(), 'admin', sysdate()
from cost_scene s
...
insert into cost_fee_variable_rel (scene_id, fee_id, variable_id, relation_type, sort_no, remark, create_by, create_time, update_by, update_time)
select s.scene_id, f.fee_id, v.variable_id, 'REQUIRED', 10, '五险应税额按输入金额直传', 'admin', sysdate(), 'admin', sysdate()
from cost_scene s
...
insert into cost_fee_variable_rel (scene_id, fee_id, variable_id, relation_type, sort_no, remark, create_by, create_time, update_by, update_time)
select s.scene_id, f.fee_id, v.variable_id, 'REQUIRED', 10, '雇主责任险按输入金额直传', 'admin', sysdate(), 'admin', sysdate()
from cost_scene s
...
select s.scene_id, f.fee_id, 'SG_THRPT_PIECE_RATE_01', '吞吐量计件类费用规则', 'FIXED_RATE', 'AND', 100, 'ALLOCATED_THROUGHPUT_TON', 'TYPED',
       ...
       null, null, '吞吐量二次分配量按 0.261 元/吨计价', '0', 10, '首钢费用：吞吐量计件类费用', 'admin', sysdate(), 'admin', sysdate()
from cost_scene s
join cost_fee_item f on f.scene_id = s.scene_id and f.fee_code = 'SG_THRPT_PIECE_FEE'
where s.scene_code = 'SHOUGANG-ORE-HR-001'
...
select s.scene_id, f.fee_id, 'SG_FEMALE_SHIFT_RATE_01', '女工固定类劳务费规则', 'FIXED_RATE', 'AND', 100, 'FEMALE_ATTENDANCE_EQUIV', 'TYPED',
       ...
       null, null, '女工固定类劳务费按 21700/6 * 女工出勤折算量计价', '0', 20, '首钢费用：女工（倒班，编制 6 人）', 'admin', sysdate(), 'admin', sysdate()
from cost_scene s
join cost_fee_item f on f.scene_id = s.scene_id and f.fee_code = 'SG_FEMALE_SHIFT_LABOR'
where s.scene_code = 'SHOUGANG-ORE-HR-001'
...
select s.scene_id, f.fee_id, 'SG_SPECIAL_SHIFT_RATE_01', '清料专班库场专班固定类劳务费规则', 'FIXED_RATE', 'AND', 100, 'SPECIAL_ATTENDANCE_EQUIV', 'TYPED',
       ...
       null, null, '清料专班库场专班固定类劳务费按 253000/30 * 专班出勤折算量计价', '0', 30, '首钢费用：清料专班、库场专班（白班，编制 30 人）', 'admin', sysdate(), 'admin', sysdate()
from cost_scene s
join cost_fee_item f on f.scene_id = s.scene_id and f.fee_code = 'SG_SPECIAL_SHIFT_LABOR'
where s.scene_code = 'SHOUGANG-ORE-HR-001'
...
select s.scene_id, f.fee_id, 'SG_HOLD_CLEANING_RATE_01', '清舱劳务费规则', 'FIXED_RATE', 'AND', 100, 'HOLD_COUNT', 'TYPED',
       ...
       null, null, '清舱劳务费按 250 元/舱计价', '0', 40, '首钢费用：清舱劳务费', 'admin', sysdate(), 'admin', sysdate()
from cost_scene s
join cost_fee_item f on f.scene_id = s.scene_id and f.fee_code = 'SG_HOLD_CLEANING_LABOR'
where s.scene_code = 'SHOUGANG-ORE-HR-001'
...
select s.scene_id, f.fee_id, 'SG_COVER_ODD_JOB_GROUPED_01', '苫盖零工劳务费组合定价规则', 'FIXED_RATE', 'OR', 100, 'COVER_WORKLOAD_TON', 'GROUPED',
       ...
       null, null, '按苫盖/揭盖动作和货种命中单价后乘作业量', '0', 50, '首钢费用：苫盖零工劳务费（很少发生）', 'admin', sysdate(), 'admin', sysdate()
from cost_scene s
join cost_fee_item f on f.scene_id = s.scene_id and f.fee_code = 'SG_COVER_ODD_JOB_LABOR'
where s.scene_code = 'SHOUGANG-ORE-HR-001'
...
select s.scene_id, f.fee_id, 'SG_MOORING_GROUPED_01', '带缆费组合定价规则', 'FIXED_RATE', 'OR', 100, 'MOORING_HEADCOUNT', 'GROUPED',
       ...
       null, null, '按带/解缆动作命中单价后乘第三方整理后的作业人数', '0', 60, '首钢费用：带缆费', 'admin', sysdate(), 'admin', sysdate()
from cost_scene s
join cost_fee_item f on f.scene_id = s.scene_id and f.fee_code = 'SG_MOORING_FEE'
where s.scene_code = 'SHOUGANG-ORE-HR-001'
...
select s.scene_id, f.fee_id, 'SG_ODD_JOB_RATE_01', '零工费规则', 'FIXED_RATE', 'AND', 100, 'ODD_JOB_HOURS', 'TYPED',
       ...
       null, null, '零工费按 5 元/小时计价', '0', 70, '首钢费用：零工费', 'admin', sysdate(), 'admin', sysdate()
from cost_scene s
join cost_fee_item f on f.scene_id = s.scene_id and f.fee_code = 'SG_ODD_JOB_FEE'
where s.scene_code = 'SHOUGANG-ORE-HR-001'
...
select s.scene_id, f.fee_id, 'SG_DUTY_SHIFT_FORMULA_01', '值守专班劳务费公式规则', 'FORMULA', 'AND', 100, '', 'TYPED',
       null,
       '(吞吐量计件类费用 - 女工固定类劳务费 - 清料/库场专班固定类劳务费 - 清舱劳务费 - 苫盖零工劳务费 - 带缆费 - 零工费) * 值守专班分摊系数',
       'SG_RULE_DUTY_SHIFT_LABOR_AMOUNT', '值守专班劳务费按前置费用差额和分摊系数计算', '0', 80, '首钢费用：值守专班劳务费', 'admin', sysdate(), 'admin', sysdate()
from cost_scene s
join cost_fee_item f on f.scene_id = s.scene_id and f.fee_code = 'SG_DUTY_SHIFT_LABOR'
where s.scene_code = 'SHOUGANG-ORE-HR-001'
...
select s.scene_id, f.fee_id, 'SG_SEASONAL_ALLOWANCE_FORMULA_01', '季节性补贴公式规则', 'FORMULA', 'AND', 100, '', 'TYPED',
       null,
       '若账期属于 12/01/02/03，则 500 * 季节性补贴计发份额，否则为 0',
       'SG_RULE_SEASONAL_ALLOWANCE_AMOUNT', '季节性补贴按账期和计发份额计算', '0', 90, '首钢费用：季节性补贴；春节补贴暂不纳入', 'admin', sysdate(), 'admin', sysdate()
from cost_scene s
join cost_fee_item f on f.scene_id = s.scene_id and f.fee_code = 'SG_SEASONAL_ALLOWANCE'
where s.scene_code = 'SHOUGANG-ORE-HR-001'
...
select s.scene_id, f.fee_id, 'SG_OVERTIME_RATE_01', '加班费用规则', 'FIXED_RATE', 'AND', 100, 'OVERTIME_DAYS', 'TYPED',
       ...
       null, null, '加班费用按 240 元/天计价', '0', 100, '首钢费用：加班费用', 'admin', sysdate(), 'admin', sysdate()
from cost_scene s
join cost_fee_item f on f.scene_id = s.scene_id and f.fee_code = 'SG_OVERTIME_FEE'
where s.scene_code = 'SHOUGANG-ORE-HR-001'
...
select s.scene_id, f.fee_id, 'SG_UNIT_BEARING_RATE_01', '单位承担费用规则', 'FIXED_RATE', 'AND', 100, 'UNIT_BEARING_AMOUNT', 'TYPED',
       ...
       null, null, '单位承担费用按录入金额直传', '0', 110, '首钢费用：单位承担部分的费用', 'admin', sysdate(), 'admin', sysdate()
from cost_scene s
join cost_fee_item f on f.scene_id = s.scene_id and f.fee_code = 'SG_UNIT_BEARING_FEE'
where s.scene_code = 'SHOUGANG-ORE-HR-001'
...
select s.scene_id, f.fee_id, 'SG_INSURANCE_TAXABLE_RATE_01', '五险应税额规则', 'FIXED_RATE', 'AND', 100, 'INSURANCE_TAXABLE_AMOUNT', 'TYPED',
       ...
       null, null, '五险应税额按录入金额直传', '0', 120, '首钢费用：五险应税额', 'admin', sysdate(), 'admin', sysdate()
from cost_scene s
join cost_fee_item f on f.scene_id = s.scene_id and f.fee_code = 'SG_INSURANCE_TAXABLE_FEE'
where s.scene_code = 'SHOUGANG-ORE-HR-001'
...
select s.scene_id, f.fee_id, 'SG_EMPLOYER_LIABILITY_RATE_01', '雇主责任险规则', 'FIXED_RATE', 'AND', 100, 'EMPLOYER_LIABILITY_AMOUNT', 'TYPED',
       ...
       null, null, '雇主责任险按录入金额直传', '0', 130, '首钢费用：雇主责任险', 'admin', sysdate(), 'admin', sysdate()
from cost_scene s
join cost_fee_item f on f.scene_id = s.scene_id and f.fee_code = 'SG_EMPLOYER_LIABILITY_FEE'
where s.scene_code = 'SHOUGANG-ORE-HR-001'
...
select s.scene_id, f.fee_id, 'SG_MANAGEMENT_FORMULA_01', '协力单位管理费公式规则', 'FORMULA', 'AND', 100, '', 'TYPED',
       ...
       'SG_RULE_MANAGEMENT_FEE_AMOUNT', '协力单位管理费按非保险费用合计乘 16.77% 计算', '0', 140, '首钢费用：协力单位管理费', 'admin', sysdate(), 'admin', sysdate()
from cost_scene s
...
select s.scene_id, r.rule_id, 1, 10, 'COVER_ACTION', '苫盖动作', 'EQ', 'COVER', '0', '组 1：苫焦煤垛', 'admin', sysdate(), 'admin', sysdate()
from cost_scene s
...
insert into cost_rule_condition (scene_id, rule_id, group_no, sort_no, variable_code, display_name, operator_code, compare_value, status, remark, create_by, create_time, update_by, update_time)
select s.scene_id, r.rule_id, 1, 20, 'COVER_CARGO_TYPE', '苫盖货种', 'EQ', 'COAL', '0', '组 1：苫焦煤垛', 'admin', sysdate(), 'admin', sysdate()
from cost_scene s
join cost_rule r on r.scene_id = s.scene_id and r.rule_code = 'SG_COVER_ODD_JOB_GROUPED_01'
where s.scene_code = 'SHOUGANG-ORE-HR-001'
...
insert into cost_rule_condition (scene_id, rule_id, group_no, sort_no, variable_code, display_name, operator_code, compare_value, status, remark, create_by, create_time, update_by, update_time)
select s.scene_id, r.rule_id, 2, 10, 'COVER_ACTION', '苫盖动作', 'EQ', 'UNCOVER', '0', '组 2：揭焦煤垛', 'admin', sysdate(), 'admin', sysdate()
from cost_scene s
join cost_rule r on r.scene_id = s.scene_id and r.rule_code = 'SG_COVER_ODD_JOB_GROUPED_01'
where s.scene_code = 'SHOUGANG-ORE-HR-001'
...
insert into cost_rule_condition (scene_id, rule_id, group_no, sort_no, variable_code, display_name, operator_code, compare_value, status, remark, create_by, create_time, update_by, update_time)
select s.scene_id, r.rule_id, 2, 20, 'COVER_CARGO_TYPE', '苫盖货种', 'EQ', 'COAL', '0', '组 2：揭焦煤垛', 'admin', sysdate(), 'admin', sysdate()
from cost_scene s
join cost_rule r on r.scene_id = s.scene_id and r.rule_code = 'SG_COVER_ODD_JOB_GROUPED_01'
where s.scene_code = 'SHOUGANG-ORE-HR-001'
...
insert into cost_rule_condition (scene_id, rule_id, group_no, sort_no, variable_code, display_name, operator_code, compare_value, status, remark, create_by, create_time, update_by, update_time)
select s.scene_id, r.rule_id, 3, 10, 'COVER_ACTION', '苫盖动作', 'EQ', 'COVER', '0', '组 3：苫矿石垛', 'admin', sysdate(), 'admin', sysdate()
from cost_scene s
join cost_rule r on r.scene_id = s.scene_id and r.rule_code = 'SG_COVER_ODD_JOB_GROUPED_01'
where s.scene_code = 'SHOUGANG-ORE-HR-001'
...
insert into cost_rule_condition (scene_id, rule_id, group_no, sort_no, variable_code, display_name, operator_code, compare_value, status, remark, create_by, create_time, update_by, update_time)
select s.scene_id, r.rule_id, 3, 20, 'COVER_CARGO_TYPE', '苫盖货种', 'EQ', 'ORE', '0', '组 3：苫矿石垛', 'admin', sysdate(), 'admin', sysdate()
from cost_scene s
join cost_rule r on r.scene_id = s.scene_id and r.rule_code = 'SG_COVER_ODD_JOB_GROUPED_01'
where s.scene_code = 'SHOUGANG-ORE-HR-001'
...
insert into cost_rule_condition (scene_id, rule_id, group_no, sort_no, variable_code, display_name, operator_code, compare_value, status, remark, create_by, create_time, update_by, update_time)
select s.scene_id, r.rule_id, 4, 10, 'COVER_ACTION', '苫盖动作', 'EQ', 'UNCOVER', '0', '组 4：揭矿石垛', 'admin', sysdate(), 'admin', sysdate()
from cost_scene s
join cost_rule r on r.scene_id = s.scene_id and r.rule_code = 'SG_COVER_ODD_JOB_GROUPED_01'
where s.scene_code = 'SHOUGANG-ORE-HR-001'
...
insert into cost_rule_condition (scene_id, rule_id, group_no, sort_no, variable_code, display_name, operator_code, compare_value, status, remark, create_by, create_time, update_by, update_time)
select s.scene_id, r.rule_id, 4, 20, 'COVER_CARGO_TYPE', '苫盖货种', 'EQ', 'ORE', '0', '组 4：揭矿石垛', 'admin', sysdate(), 'admin', sysdate()
from cost_scene s
join cost_rule r on r.scene_id = s.scene_id and r.rule_code = 'SG_COVER_ODD_JOB_GROUPED_01'
where s.scene_code = 'SHOUGANG-ORE-HR-001'
...
insert into cost_rule_condition (scene_id, rule_id, group_no, sort_no, variable_code, display_name, operator_code, compare_value, status, remark, create_by, create_time, update_by, update_time)
select s.scene_id, r.rule_id, 1, 10, 'MOORING_ACTION', '带缆动作', 'EQ', 'MOOR', '0', '组 1：带缆', 'admin', sysdate(), 'admin', sysdate()
from cost_scene s
...
insert into cost_rule_condition (scene_id, rule_id, group_no, sort_no, variable_code, display_name, operator_code, compare_value, status, remark, create_by, create_time, update_by, update_time)
select s.scene_id, r.rule_id, 2, 10, 'MOORING_ACTION', '带缆动作', 'EQ', 'UNMOOR', '0', '组 2：解缆', 'admin', sysdate(), 'admin', sysdate()
from cost_scene s
join cost_rule r on r.scene_id = s.scene_id and r.rule_code = 'SG_MOORING_GROUPED_01'
where s.scene_code = 'SHOUGANG-ORE-HR-001'
...
-- 二、首钢矿石设备费用配置
insert into sys_dict_type (dict_id, dict_name, dict_type, status, create_by, create_time, remark)
select (select coalesce(max(dict_id), 0) + 1 from sys_dict_type), '核算-首钢设备零工作业项目', 'cost_sg_device_odd_project', '0', 'admin', sysdate(), '首钢矿石设备零工作业项目字典'
from dual
where not exists (select 1 from sys_dict_type where dict_type = 'cost_sg_device_odd_project');

insert into sys_dict_data (dict_code, dict_sort, dict_label, dict_value, dict_type, css_class, list_class, is_default, status, create_by, create_time, remark)
select (select coalesce(max(dict_code), 0) + 1 from sys_dict_data), 10, '铲车零工', '665089828246167685', 'cost_sg_device_odd_project', '', 'primary', 'N', '0', 'admin', sysdate(), '105元/小时'
from dual
...
insert into sys_dict_data (dict_code, dict_sort, dict_label, dict_value, dict_type, css_class, list_class, is_default, status, create_by, create_time, remark)
select (select coalesce(max(dict_code), 0) + 1 from sys_dict_data), 20, '抓车零工', '665090766193205381', 'cost_sg_device_odd_project', '', 'warning', 'N', '0', 'admin', sysdate(), '235元/小时'
from dual
...
insert into sys_dict_data (dict_code, dict_sort, dict_label, dict_value, dict_type, css_class, list_class, is_default, status, create_by, create_time, remark)
select (select coalesce(max(dict_code), 0) + 1 from sys_dict_data), 30, '抽水零工', '14108513240606131', 'cost_sg_device_odd_project', '', 'info', 'N', '0', 'admin', sysdate(), '30元/小时'
from dual
where not exists (select 1 from sys_dict_data where dict_type = 'cost_sg_device_odd_project' and dict_value = '14108513240606131');

insert into sys_dict_data (dict_code, dict_sort, dict_label, dict_value, dict_type, css_class, list_class, is_default, status, create_by, create_time, remark)
select (select coalesce(max(dict_code), 0) + 1 from sys_dict_data), 40, '洒水车零工', '14108514536662454', 'cost_sg_device_odd_project', '', 'success', 'N', '0', 'admin', sysdate(), '99元/小时'
from dual
where not exists (select 1 from sys_dict_data where dict_type = 'cost_sg_device_odd_project' and dict_value = '14108514536662454');

insert into sys_dict_data (dict_code, dict_sort, dict_label, dict_value, dict_type, css_class, list_class, is_default, status, create_by, create_time, remark)
select (select coalesce(max(dict_code), 0) + 1 from sys_dict_data), 50, '清扫铲作业', '14108519400334776', 'cost_sg_device_odd_project', '', 'primary', 'N', '0', 'admin', sysdate(), '0.04元/吨'
from dual
where not exists (select 1 from sys_dict_data where dict_type = 'cost_sg_device_odd_project' and dict_value = '14108519400334776');

insert into sys_dict_data (dict_code, dict_sort, dict_label, dict_value, dict_type, css_class, list_class, is_default, status, create_by, create_time, remark)
select (select coalesce(max(dict_code), 0) + 1 from sys_dict_data), 60, '板车零工', '665090887916101765', 'cost_sg_device_odd_project', '', 'warning', 'N', '0', 'admin', sysdate(), '50元/小时'
from dual
...
insert into sys_dict_data (dict_code, dict_sort, dict_label, dict_value, dict_type, css_class, list_class, is_default, status, create_by, create_time, remark)
select (select coalesce(max(dict_code), 0) + 1 from sys_dict_data), 70, '翻斗零工', '14108523792311734', 'cost_sg_device_odd_project', '', 'danger', 'N', '0', 'admin', sysdate(), '90元/小时'
from dual
where not exists (select 1 from sys_dict_data where dict_type = 'cost_sg_device_odd_project' and dict_value = '14108523792311734');

insert into sys_dict_data (dict_code, dict_sort, dict_label, dict_value, dict_type, css_class, list_class, is_default, status, create_by, create_time, remark)
select (select coalesce(max(dict_code), 0) + 1 from sys_dict_data), 80, '倒运隔离墩', '669101113690545157', 'cost_sg_device_odd_project', '', 'info', 'N', '0', 'admin', sysdate(), '5.95元/块'
from dual
...
insert into sys_dict_data (dict_code, dict_sort, dict_label, dict_value, dict_type, css_class, list_class, is_default, status, create_by, create_time, remark)
select (select coalesce(max(dict_code), 0) + 1 from sys_dict_data), 90, '叉车零工', '14108525500507574', 'cost_sg_device_odd_project', '', 'success', 'N', '0', 'admin', sysdate(), '105元/小时'
from dual
...
insert into cost_variable_group (scene_id, group_code, group_name, sort_no, status, remark, create_by, create_time, update_by, update_time)
select s.scene_id, 'SG_EQ_BASE', '设备零工基础输入', 10, '0', '接口主链按作业项目ID和作业数量计价', 'admin', sysdate(), 'admin', sysdate()
from cost_scene s
...
insert into cost_variable_group (scene_id, group_code, group_name, sort_no, status, remark, create_by, create_time, update_by, update_time)
select s.scene_id, 'SG_EQ_MANUAL', '设备零工手工补充', 20, '0', '板车托车费等暂不走接口的补充项', 'admin', sysdate(), 'admin', sysdate()
from cost_scene s
where s.scene_code = 'SHOUGANG-ORE-DEVICE-001'
  and not exists (select 1 from cost_variable_group where scene_id = s.scene_id and group_code = 'SG_EQ_MANUAL');

insert into cost_variable (scene_id, group_id, variable_code, variable_name, variable_type, source_type, dict_type, data_path, formula_expr, formula_code, data_type, default_value, precision_scale, status, sort_no, remark, create_by, create_time, update_by, update_time)
select s.scene_id, g.group_id, 'DEVICE_ODD_PROJECT_ID', '设备零工作业项目ID', 'DICT', 'DICT', 'cost_sg_device_odd_project', 'DEVICE_ODD_PROJECT_ID', null, '', 'STRING', '', 0, '0', 10, '接口作业项目ID；用于命中设备零工作业费率', 'admin', sysdate(), 'admin', sysdate()
from cost_scene s
...
insert into cost_variable (scene_id, group_id, variable_code, variable_name, variable_type, source_type, dict_type, data_path, formula_expr, formula_code, data_type, default_value, precision_scale, status, sort_no, remark, create_by, create_time, update_by, update_time)
select s.scene_id, g.group_id, 'DEVICE_ODD_QUANTITY', '设备零工作业数量', 'NUMBER', 'INPUT', '', 'DEVICE_ODD_QUANTITY', null, '', 'NUMBER', '0', 4, '0', 20, '统一作业数量字段；具体计量单位由命中的作业项目决定', 'admin', sysdate(), 'admin', sysdate()
from cost_scene s
join cost_variable_group g on g.scene_id = s.scene_id and g.group_code = 'SG_EQ_BASE'
where s.scene_code = 'SHOUGANG-ORE-DEVICE-001'
...
insert into cost_variable (scene_id, group_id, variable_code, variable_name, variable_type, source_type, dict_type, data_path, formula_expr, formula_code, data_type, default_value, precision_scale, status, sort_no, remark, create_by, create_time, update_by, update_time)
select s.scene_id, g.group_id, 'FLATBED_TOW_COUNT', '板车托车次数', 'NUMBER', 'INPUT', '', 'FLATBED_TOW_COUNT', null, '', 'NUMBER', '0', 2, '0', 10, '板车托车费手工录入次数', 'admin', sysdate(), 'admin', sysdate()
from cost_scene s
...
insert into cost_fee_item (scene_id, fee_code, fee_name, fee_category, unit_code, factor_summary, scope_description, object_dimension, sort_no, status, remark, create_by, create_time, update_by, update_time)
select s.scene_id, 'SG_DEVICE_ODD_JOB_FEE', '设备零工作业费', '设备费', '作业量', '按作业项目ID命中单价后乘作业数量', '适用于首钢矿石设备零工作业接口项目', '协力单位', 10, '0', '接口主链设备零工作业费；覆盖 9 个有费率项目', 'admin', sysdate(), 'admin', sysdate()
from cost_scene s
where s.scene_code = 'SHOUGANG-ORE-DEVICE-001'
  and not exists (select 1 from cost_fee_item where scene_id = s.scene_id and fee_code = 'SG_DEVICE_ODD_JOB_FEE');

insert into cost_fee_item (scene_id, fee_code, fee_name, fee_category, unit_code, factor_summary, scope_description, object_dimension, sort_no, status, remark, create_by, create_time, update_by, update_time)
select s.scene_id, 'SG_DEVICE_FLATBED_TOW_FEE', '板车托车费', '设备费', '次', '500元/次 * 板车托车次数', '适用于手工录入板车托车费', '协力单位', 20, '0', '作为手工录入补充项，如接口确认稳定可并入作业项目计价', 'admin', sysdate(), 'admin', sysdate()
from cost_scene s
where s.scene_code = 'SHOUGANG-ORE-DEVICE-001'
  and not exists (select 1 from cost_fee_item where scene_id = s.scene_id and fee_code = 'SG_DEVICE_FLATBED_TOW_FEE');

insert into cost_fee_variable_rel (scene_id, fee_id, variable_id, relation_type, sort_no, remark, create_by, create_time, update_by, update_time)
select s.scene_id, f.fee_id, v.variable_id, 'REQUIRED', 10, '设备零工作业费依赖作业项目ID', 'admin', sysdate(), 'admin', sysdate()
from cost_scene s
...
insert into cost_fee_variable_rel (scene_id, fee_id, variable_id, relation_type, sort_no, remark, create_by, create_time, update_by, update_time)
select s.scene_id, f.fee_id, v.variable_id, 'REQUIRED', 20, '设备零工作业费依赖作业数量', 'admin', sysdate(), 'admin', sysdate()
from cost_scene s
join cost_fee_item f on f.scene_id = s.scene_id and f.fee_code = 'SG_DEVICE_ODD_JOB_FEE'
...
insert into cost_fee_variable_rel (scene_id, fee_id, variable_id, relation_type, sort_no, remark, create_by, create_time, update_by, update_time)
select s.scene_id, f.fee_id, v.variable_id, 'REQUIRED', 10, '板车托车费依赖托车次数', 'admin', sysdate(), 'admin', sysdate()
from cost_scene s
...
select s.scene_id, f.fee_id, 'SG_DEVICE_ODD_JOB_GROUPED_01', '设备零工作业项目组合定价规则', 'FIXED_RATE', 'OR', 100, 'DEVICE_ODD_QUANTITY', 'GROUPED',
       ...
       null, null, '设备零工作业费按项目ID命中单价后乘作业数量', '0', 10, '首钢设备零工作业接口项目定价规则', 'admin', sysdate(), 'admin', sysdate()
from cost_scene s
join cost_fee_item f on f.scene_id = s.scene_id and f.fee_code = 'SG_DEVICE_ODD_JOB_FEE'
where s.scene_code = 'SHOUGANG-ORE-DEVICE-001'
...
select s.scene_id, f.fee_id, 'SG_DEVICE_FLATBED_TOW_RATE_01', '板车托车费固定费率规则', 'FIXED_RATE', 'AND', 100, 'FLATBED_TOW_COUNT', 'TYPED',
       ...
       null, null, '板车托车费按 500 元/次计价', '0', 20, '首钢板车托车费手工补充规则', 'admin', sysdate(), 'admin', sysdate()
from cost_scene s
join cost_fee_item f on f.scene_id = s.scene_id and f.fee_code = 'SG_DEVICE_FLATBED_TOW_FEE'
where s.scene_code = 'SHOUGANG-ORE-DEVICE-001'
...
insert into cost_rule_condition (scene_id, rule_id, group_no, sort_no, variable_code, display_name, operator_code, compare_value, status, remark, create_by, create_time, update_by, update_time)
select s.scene_id, r.rule_id, 1, 10, 'DEVICE_ODD_PROJECT_ID', '设备零工作业项目ID', 'EQ', '665089828246167685', '0', '组1：铲车零工', 'admin', sysdate(), 'admin', sysdate()
from cost_scene s
...
insert into cost_rule_condition (scene_id, rule_id, group_no, sort_no, variable_code, display_name, operator_code, compare_value, status, remark, create_by, create_time, update_by, update_time)
select s.scene_id, r.rule_id, 2, 10, 'DEVICE_ODD_PROJECT_ID', '设备零工作业项目ID', 'EQ', '665090766193205381', '0', '组2：抓车零工', 'admin', sysdate(), 'admin', sysdate()
from cost_scene s
join cost_rule r on r.scene_id = s.scene_id and r.rule_code = 'SG_DEVICE_ODD_JOB_GROUPED_01'
where s.scene_code = 'SHOUGANG-ORE-DEVICE-001'
...
insert into cost_rule_condition (scene_id, rule_id, group_no, sort_no, variable_code, display_name, operator_code, compare_value, status, remark, create_by, create_time, update_by, update_time)
select s.scene_id, r.rule_id, 3, 10, 'DEVICE_ODD_PROJECT_ID', '设备零工作业项目ID', 'EQ', '14108513240606131', '0', '组3：抽水零工', 'admin', sysdate(), 'admin', sysdate()
from cost_scene s
join cost_rule r on r.scene_id = s.scene_id and r.rule_code = 'SG_DEVICE_ODD_JOB_GROUPED_01'
where s.scene_code = 'SHOUGANG-ORE-DEVICE-001'
...
insert into cost_rule_condition (scene_id, rule_id, group_no, sort_no, variable_code, display_name, operator_code, compare_value, status, remark, create_by, create_time, update_by, update_time)
select s.scene_id, r.rule_id, 4, 10, 'DEVICE_ODD_PROJECT_ID', '设备零工作业项目ID', 'EQ', '14108514536662454', '0', '组4：洒水车零工', 'admin', sysdate(), 'admin', sysdate()
from cost_scene s
join cost_rule r on r.scene_id = s.scene_id and r.rule_code = 'SG_DEVICE_ODD_JOB_GROUPED_01'
where s.scene_code = 'SHOUGANG-ORE-DEVICE-001'
...
insert into cost_rule_condition (scene_id, rule_id, group_no, sort_no, variable_code, display_name, operator_code, compare_value, status, remark, create_by, create_time, update_by, update_time)
select s.scene_id, r.rule_id, 5, 10, 'DEVICE_ODD_PROJECT_ID', '设备零工作业项目ID', 'EQ', '14108519400334776', '0', '组5：清扫铲作业', 'admin', sysdate(), 'admin', sysdate()
from cost_scene s
join cost_rule r on r.scene_id = s.scene_id and r.rule_code = 'SG_DEVICE_ODD_JOB_GROUPED_01'
where s.scene_code = 'SHOUGANG-ORE-DEVICE-001'
...
insert into cost_rule_condition (scene_id, rule_id, group_no, sort_no, variable_code, display_name, operator_code, compare_value, status, remark, create_by, create_time, update_by, update_time)
select s.scene_id, r.rule_id, 6, 10, 'DEVICE_ODD_PROJECT_ID', '设备零工作业项目ID', 'EQ', '665090887916101765', '0', '组6：板车零工', 'admin', sysdate(), 'admin', sysdate()
from cost_scene s
join cost_rule r on r.scene_id = s.scene_id and r.rule_code = 'SG_DEVICE_ODD_JOB_GROUPED_01'
where s.scene_code = 'SHOUGANG-ORE-DEVICE-001'
...
insert into cost_rule_condition (scene_id, rule_id, group_no, sort_no, variable_code, display_name, operator_code, compare_value, status, remark, create_by, create_time, update_by, update_time)
select s.scene_id, r.rule_id, 7, 10, 'DEVICE_ODD_PROJECT_ID', '设备零工作业项目ID', 'EQ', '14108523792311734', '0', '组7：翻斗零工', 'admin', sysdate(), 'admin', sysdate()
from cost_scene s
join cost_rule r on r.scene_id = s.scene_id and r.rule_code = 'SG_DEVICE_ODD_JOB_GROUPED_01'
where s.scene_code = 'SHOUGANG-ORE-DEVICE-001'
...
insert into cost_rule_condition (scene_id, rule_id, group_no, sort_no, variable_code, display_name, operator_code, compare_value, status, remark, create_by, create_time, update_by, update_time)
select s.scene_id, r.rule_id, 8, 10, 'DEVICE_ODD_PROJECT_ID', '设备零工作业项目ID', 'EQ', '669101113690545157', '0', '组8：倒运隔离墩', 'admin', sysdate(), 'admin', sysdate()
from cost_scene s
join cost_rule r on r.scene_id = s.scene_id and r.rule_code = 'SG_DEVICE_ODD_JOB_GROUPED_01'
where s.scene_code = 'SHOUGANG-ORE-DEVICE-001'
...
insert into cost_rule_condition (scene_id, rule_id, group_no, sort_no, variable_code, display_name, operator_code, compare_value, status, remark, create_by, create_time, update_by, update_time)
select s.scene_id, r.rule_id, 9, 10, 'DEVICE_ODD_PROJECT_ID', '设备零工作业项目ID', 'EQ', '14108525500507574', '0', '组9：叉车零工', 'admin', sysdate(), 'admin', sysdate()
from cost_scene s
join cost_rule r on r.scene_id = s.scene_id and r.rule_code = 'SG_DEVICE_ODD_JOB_GROUPED_01'
where s.scene_code = 'SHOUGANG-ORE-DEVICE-001'
